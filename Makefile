...
#    Updated: 2020/08/12 16:21:47 by user42           ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRCS = files/srcs/parsing/ft_check_map.c files/srcs/parsing/ft_colors.c files/srcs/parsing/ft_resolution.c \
		...
		files/srcs/raycasting/ft_draw_textures.c files/srcs/sprites/ft_sprites.c \
		files/srcs/save/ft_save.c files/srcs/sprites/ft_sprites_utils.c files/srcs/utils/ft_init_txt.c files/srcs/utils/ft_utils2.c files/srcs/utils/ft_parse_error.c \
