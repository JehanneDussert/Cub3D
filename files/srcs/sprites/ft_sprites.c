...
/*   Updated: 2020/06/26 17:48:21 by jehannedu        ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_spr_txt(t_all *all, t_spr_txt *spr_txt)
{
	...
	while (i < spr_txt->draw_ex)
	{
		...
		+ spr_txt->screen_x)) * W_H / spr_txt->spr_w) / 256);
		j = spr_txt->draw_sy;
...
void	ft_draw_spr(t_all *all, t_spr_txt *spr_txt, t_spr *spr, int *spr_order)
{
	...
	spr_txt->transform_x = spr_txt->inv_det * (all->vec->dir_y * spr->x
	- all->vec->dir_x * spr->y);
	spr_txt->transform_y = spr_txt->inv_det * (-all->vec->plane_y * spr->x
	+ all->vec->plane_x * spr->y);
